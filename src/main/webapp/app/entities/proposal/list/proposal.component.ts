...
export class ProposalComponent implements OnInit {
  ...
  protected readonly proposalService = inject(ProposalService);
  ...
  trackId = (item: IProposal): number => this.proposalService.getProposalIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.proposals.set(dataFromBody);
  }
